...
object ConfigManager {
    ...
    var mysql_host: String = config.getString("Storage.mysql.host") ?: "localhost"
    var mysql_port = config.getString("Storage.mysql.port") ?: "3306"
    ...
    fun load() {
        ...
        mysql_port = config.getString("Storage.mysql.prot") ?: "3306"
